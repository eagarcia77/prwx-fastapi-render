const CACHE = "prwx-desktop-v540-aurora-raincast-backend-image-proxy";
const ASSETS = ["./", "./index.html", "./live-rain.html", "./styles.css", "./storm-cinematic.css", "./map-enhancements-v33.css", "./dust-layer-v35.css", "./aurora-3d.css", "./live-rain-v54.css", "./app.js", "./api-config.js", "./aurora-caribe-panel.js", "./aurora-dust-panel.js", "./aurora-3d-command-center.js", "./live-rain-map.js", "./live-rain-v54.js", "./real-map.js", "./storm-map.js", "./storm-history-panel.js", "./manifest.webmanifest"];
