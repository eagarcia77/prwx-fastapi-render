...
from prwx.operational_v11 import run_operational_update_v11

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run PR-WX v1.1 emergency display operational update.")
    parser.add_argument("--limit", type=int, default=None, help="Limit municipalities for quick testing. Omit for all 78.")
    ...
    result = run_operational_update_v11(
        limit=args.limit,
