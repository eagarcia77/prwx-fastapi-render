...
from prwx.operational_v10 import run_operational_update_v10

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run PR-WX v1.0 temperature + realtime operational update.")
